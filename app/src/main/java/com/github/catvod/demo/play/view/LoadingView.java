package com.github.catvod.demo.play.view;
...
import com.github.catvod.demo.utlis.Utils;
...
public class LoadingView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(getContext().getResources().getColor(R.color.color_ff5c00));
        rectF = new RectF();
